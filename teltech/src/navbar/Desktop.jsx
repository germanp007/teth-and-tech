...
const Desktop = () => {
  return (
    <nav className="h-[80px]  w-screen flex justify-between shadow-sm">
      ...
      <ul className=" h-full flex justify-center items-center gap-10 mr-16 text-xl text-[#27488F]">
        <li className="group cursor-pointer flex flex-col justify-evenly h-full transition-all duration-500 relative ">
          ...
          <span className="absolute bottom-0 scale-x-0 peer-hover:bg-blue-400 w-full h-2 transform transition-transform duration-500 peer-hover:scale-x-100"></span>
        </li>
        <li className="group cursor-pointer flex flex-col justify-evenly h-full transition-all duration-500 relative ">
